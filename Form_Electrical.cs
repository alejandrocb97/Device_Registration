...
{
    /** WE ENTER THE PARAMETERS OF THE ELECTRICAL METER IN THIS WINDOW**/
    public partial class Electrical : Form
    {
        ...
        string path = @"Database\EM_data.txt";
        public Electrical()
        {
            InitializeComponent();
        }
        ...
        void Register_device()  //We write the device's data in the file
        {
            ...
            tw.WriteLine("EM {0} {1} {2} {3}", entered_id,entered_serialn,entered_trademark,entered_model);
            tw.Close();
        }
